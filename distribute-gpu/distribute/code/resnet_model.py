# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 10:22:05 2019
...
class ResNet(object):
  ...
  def _build_train_op(self, tpu_opt):
    ...
    def r1(): return tf.constant(0.1)
    def r2(): return tf.constant(0.01)
    def r3(): return tf.constant(0.001)
    def r4(): return tf.constant(0.0001)
